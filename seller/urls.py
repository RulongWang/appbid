...
urlpatterns = patterns('',
    ...
    url(r'^additional_info/(?P<pk>\d*)$', views.registerApp,
        {'flag': 3,
         'backPage': 'seller/register_content.html',
    ...
    url(r'^payment/(?P<pk>\d*)$', views.registerApp,
        {'flag': 6,
         'backPage': 'seller/register_content.html',
    ...
    url(r'^delete_attachment/(?P<pk>\d*)$', views.deleteAttachment, name='deleteAttachment'),
)
