INSERT INTO `usersetting_subscriptionitem` (`id`,`item`) VALUES
 (1,'Notify me about changes to XXX itself'),
 (2,'Subscribe me to the XXX newsletter'),
 (3,'Allow XXX to send me special offers'),
 (4,'Notify me when I\'m sent a private message'),
 (5,'Notify me when a bid or an offer is placed on one of my listings'),
 (6,'Notify me when a comment is placed on one of my listings'),
