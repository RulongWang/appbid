...
INSERT INTO appbid.notification_notificationtemplate (id, name, language, type, subject, template, description, version, create_time, last_modify, modifier_id) VALUES (13, 'unsold_end_inform_seller', 1, 1, 'Need your action immediately ', 'Dear {param1},
 ...
 7days has passed, however you didn''t start any transaction with you buyer yet. As an agreement  { creditamount } points will be deducted from your account. And you can also start your transaction right now.
Regards,
...
please go to { reset_url } to reset your password immediately. Then review and update your security settings at www.appswalk.com
Thanks,
...
INSERT INTO appbid.notification_notificationtemplate (id, name, language, type, subject, template, description, version, create_time, last_modify, modifier_id) VALUES (16, 'buyer_unpaid_inform_seller_no_bidding', 1, 1, 'Failed to sell your app ', 'Dear {param1},
...
Best regards,
Appswalk Ltd', 'This auction only has one bidder , and this bidder didnt pay the money.', '1.0', '2013-12-09 21:50:44', '2013-12-11 23:25:05', 1);
INSERT INTO appbid.notification_notificationtemplate (id, name, language, type, subject, template, description, version, create_time, last_modify, modifier_id) VALUES (17, 'buyer_unpaid_inform_buyer', 1, 1, 'Your attention please', 'Dear {param1},
...
INSERT INTO appbid.notification_notificationtemplate (id, name, language, type, subject, template, description, version, create_time, last_modify, modifier_id) VALUES (21, 'new_bid_inform_buyer', 1, 1, 'Your bidding price has been exceeded', 'Dear {param1},
